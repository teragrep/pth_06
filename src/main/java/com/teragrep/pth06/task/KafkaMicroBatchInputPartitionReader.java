...
import com.teragrep.pth06.task.kafka.KafkaRecordConverter;
import com.teragrep.pth06.planner.MockKafkaConsumerFactory;
import com.teragrep.pth06.task.kafka.RFC5424Reader;
 ...
 */
public class KafkaMicroBatchInputPartitionReader implements InputPartitionReader<InternalRow> {
    ...
    private final RFC5424Reader rfc5424Reader;
    ...
    public KafkaMicroBatchInputPartitionReader(
        ...
        this.rfc5424Reader = new RFC5424Reader();
    ...
    private InternalRow convertToRow(ConsumerRecord<byte[], byte[]> consumerRecord) throws IOException {
        ...
        rfc5424Reader.setInputStream(payload);
        rfc5424Reader.next();


        ParserResultset parserResultset = rfc5424Reader.get();
