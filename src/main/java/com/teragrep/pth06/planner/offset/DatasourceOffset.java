...
public class DatasourceOffset extends Offset implements Serializable {
    ...
    public LongOffset getArchiveOffset() {
        if (serializedDatasourceOffset.getArchiveOffset() == null) {
            throw new IllegalStateException("faulty SerializedDatasourceOffset");
        }
        return serializedDatasourceOffset.getArchiveOffset();
    }

    public KafkaOffset getKafkaOffset() {
        KafkaOffset kafkaOffset = serializedDatasourceOffset.getKafkaOffset();

        if (kafkaOffset == null || kafkaOffset.getOffsetMap() == null) {
            throw new IllegalStateException("faulty SerializedDatasourceOffset " + serializedDatasourceOffset);
        }
