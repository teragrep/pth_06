...
public class LogGroup extends TableImpl<LogGroupRecord> {
     ...
     */
    public final TableField<LogGroupRecord, UInteger> ID = createField(
     ...
     */
    public final TableField<LogGroupRecord, String> NAME = createField(
            DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, ""
    );
