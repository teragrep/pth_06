...
public class Bucket extends TableImpl<BucketRecord> {
     ...
     */
    public final TableField<BucketRecord, UShort> ID = createField(
            DSL.name("id"), org.jooq.impl.SQLDataType.SMALLINTUNSIGNED.nullable(false).identity(true), this, ""
    );

    /**
     * The column <code>journaldb.bucket.name</code>. Name of the bucket
     */
    public final TableField<BucketRecord, String> NAME = createField(
            DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "Name of the bucket"
    );
