...
public class Host extends TableImpl<HostRecord> {
     ...
     */
    public final TableField<HostRecord, UInteger> ID = createField(
     ...
     */
    public final TableField<HostRecord, String> NAME = createField(
            DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(175).nullable(false), this, ""
    );

    /**
     * The column <code>streamdb.host.gid</code>.
     */
    public final TableField<HostRecord, UInteger> GID = createField(
