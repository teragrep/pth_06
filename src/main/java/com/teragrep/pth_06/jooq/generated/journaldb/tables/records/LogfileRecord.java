...
public class LogfileRecord extends UpdatableRecordImpl<LogfileRecord> implements Record21<ULong, Date, Date, UShort, String, String, UShort, String, Timestamp, ULong, String, String, UShort, UShort, ULong, ULong, ULong, ULong, ULong, ULong, ULong> {

    private static final long serialVersionUID = -1790657226;
    ...
    /**
     * Setter for <code>journaldb.logfile.epoch_hour</code>. Log file's  epoch logdate
     */
    public void setEpochHour(ULong value) {
        set(15, value);
    }

    /**
     * Getter for <code>journaldb.logfile.epoch_hour</code>. Log file's  epoch logdate
     */
    public ULong getEpochHour() {
        return (ULong) get(15);
    }

    /**
     * Setter for <code>journaldb.logfile.epoch_expires</code>. Log file's  epoch expiration
     */
    public void setEpochExpires(ULong value) {
        set(16, value);
    }

    /**
     * Getter for <code>journaldb.logfile.epoch_expires</code>. Log file's  epoch expiration
     */
    public ULong getEpochExpires() {
        return (ULong) get(16);
    }

    /**
     * Setter for <code>journaldb.logfile.epoch_archived</code>. Log file's  epoch archived
     */
    public void setEpochArchived(ULong value) {
        set(17, value);
    }

    /**
     * Getter for <code>journaldb.logfile.epoch_archived</code>. Log file's  epoch archived
     */
    public ULong getEpochArchived() {
        return (ULong) get(17);
    }

    /**
     * Setter for <code>journaldb.logfile.ci_id</code>. Log file's foreign key to ci table
     */
    public void setCiId(ULong value) {
        set(18, value);
    }

    /**
     * Getter for <code>journaldb.logfile.ci_id</code>. Log file's foreign key to ci table
     */
    public ULong getCiId() {
        return (ULong) get(18);
    }

    /**
     * Setter for <code>journaldb.logfile.logtag_id</code>. Log file's foreign key to logtag
     */
    ...
    /**
     * Getter for <code>journaldb.logfile.logtag_id</code>. Log file's foreign key to logtag
     */
    public ULong getLogtagId() {
        return (ULong) get(19);
    }
    ...
    @Override
    public Row21<ULong, Date, Date, UShort, String, String, UShort, String, Timestamp, ULong, String, String, UShort, UShort, ULong, ULong, ULong, ULong, ULong, ULong, ULong> valuesRow() {
    ...
    public Field<ULong> field16() {
        return Logfile.LOGFILE.EPOCH_HOUR;
    }

    @Override
    public Field<ULong> field17() {
        return Logfile.LOGFILE.EPOCH_EXPIRES;
    }

    @Override
    public Field<ULong> field18() {
        return Logfile.LOGFILE.EPOCH_ARCHIVED;
    }

    @Override
    public Field<ULong> field19() {
        return Logfile.LOGFILE.CI_ID;
    }

    @Override
    public Field<ULong> field20() {
        return Logfile.LOGFILE.LOGTAG_ID;
    }
    ...
    public ULong component17() {
        return getEpochExpires();
    }

    @Override
    public ULong component18() {
        return getEpochArchived();
    }
    ...
    @Override
    public LogfileRecord value13(UShort value) {
    ...
    @Override
    public LogfileRecord value17(ULong value) {
        setEpochExpires(value);
        return this;
    }

    @Override
    public LogfileRecord value18(ULong value) {
        setEpochArchived(value);
        return this;
    }
     ...
     */
    public LogfileRecord(ULong id, Date logdate, Date expiration, UShort bucketId, String path, String objectKeyHash, UShort hostId, String originalFilename, Timestamp archived, ULong fileSize, String sha256Checksum, String archiveEtag, UShort sourceSystemId, UShort categoryId, ULong uncompressedFileSize, ULong epochHour, ULong epochExpires, ULong epochArchived, ULong ciId, ULong logtagId, ULong objectFormatId) {
        super(Logfile.LOGFILE);
        ...
        set(11, archiveEtag);
        set(12, sourceSystemId);
        set(13, categoryId);
        set(14, uncompressedFileSize);
        set(15, epochHour);
        set(16, epochExpires);
        set(17, epochArchived);
        set(18, ciId);
        set(19, logtagId);
        set(20, objectFormatId);
    }
}
