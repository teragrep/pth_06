...
public class LogfileRecord extends UpdatableRecordImpl<LogfileRecord> implements Record19<ULong, Date, Date, UShort, String, String, UShort, String, Timestamp, ULong, String, String, UShort, UShort, ULong, ULong, ULong, ULong, ULong> {

    private static final long serialVersionUID = -738081732;
    ...
    @Override
    public Row19<ULong, Date, Date, UShort, String, String, UShort, String, Timestamp, ULong, String, String, UShort, UShort, ULong, ULong, ULong, ULong, ULong> fieldsRow() {
        return (Row19) super.fieldsRow();
    }

    @Override
    public Row19<ULong, Date, Date, UShort, String, String, UShort, String, Timestamp, ULong, String, String, UShort, UShort, ULong, ULong, ULong, ULong, ULong> valuesRow() {
    ...
    @Override
    public LogfileRecord values(ULong value1, Date value2, Date value3, UShort value4, String value5, String value6, UShort value7, String value8, Timestamp value9, ULong value10, String value11, String value12, UShort value13, UShort value14, ULong value15, ULong value16, ULong value17, ULong value18, ULong value19) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LogfileRecord(ULong id, Date logdate, Date expiration, UShort bucketId, String path, String objectKeyHash, UShort hostId, String originalFilename, Timestamp archived, ULong fileSize, String sha256Checksum, String archiveEtag, UShort sourceSystemId, UShort categoryId, ULong uncompressedFileSize, ULong epochHour, ULong epochExpires, ULong epochArchived, ULong logtagId) {
        super(Logfile.LOGFILE);
