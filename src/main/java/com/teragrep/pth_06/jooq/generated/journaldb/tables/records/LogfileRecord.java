...
public class LogfileRecord extends UpdatableRecordImpl<LogfileRecord> implements Record21<ULong, Date, Date, UShort, String, String, UShort, String, Timestamp, ULong, String, String, String, UShort, UShort, ULong, ULong, ULong, ULong, ULong, ULong> {

    private static final long serialVersionUID = -1181491508;
    ...
    @Override
    public Row21<ULong, Date, Date, UShort, String, String, UShort, String, Timestamp, ULong, String, String, String, UShort, UShort, ULong, ULong, ULong, ULong, ULong, ULong> valuesRow() {
