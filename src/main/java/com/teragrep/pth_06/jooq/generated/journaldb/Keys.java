...
/**
 * A class modelling foreign key relationships and constraints of tables of the <code>journaldb</code> schema.
 */
@Generated(value = {
...
public class Keys {
    ...
    private static class Identities0 {
        ...
        public static Identity<BucketRecord, UShort> IDENTITY_BUCKET = Internal
                .createIdentity(Bucket.BUCKET, Bucket.BUCKET.ID);
        public static Identity<HostRecord, UShort> IDENTITY_HOST = Internal.createIdentity(Host.HOST, Host.HOST.ID);
        public static Identity<LogfileRecord, ULong> IDENTITY_LOGFILE = Internal
                .createIdentity(Logfile.LOGFILE, Logfile.LOGFILE.ID);
    }

    private static class UniqueKeys0 {

        public static final UniqueKey<BucketRecord> KEY_BUCKET_PRIMARY = Internal
                .createUniqueKey(Bucket.BUCKET, "KEY_bucket_PRIMARY", Bucket.BUCKET.ID);
        public static final UniqueKey<BucketRecord> KEY_BUCKET_UIX_BUCKET_NAME = Internal
                .createUniqueKey(Bucket.BUCKET, "KEY_bucket_uix_bucket_name", Bucket.BUCKET.NAME);
        ...
        public static final UniqueKey<HostRecord> KEY_HOST_UIX_HOST_NAME = Internal
                .createUniqueKey(Host.HOST, "KEY_host_uix_host_name", Host.HOST.NAME);
        public static final UniqueKey<LogfileRecord> KEY_LOGFILE_PRIMARY = Internal
                .createUniqueKey(Logfile.LOGFILE, "KEY_logfile_PRIMARY", Logfile.LOGFILE.ID);
        public static final UniqueKey<LogfileRecord> KEY_LOGFILE_UIX_LOGFILE_OBJECT_HASH = Internal
                .createUniqueKey(Logfile.LOGFILE, "KEY_logfile_uix_logfile_object_hash", Logfile.LOGFILE.OBJECT_KEY_HASH);
    }

    private static class ForeignKeys0 {

        public static final ForeignKey<LogfileRecord, BucketRecord> LOGFILE_IBFK_1 = Internal
                .createForeignKey(
                        com.teragrep.pth_06.jooq.generated.journaldb.Keys.KEY_BUCKET_PRIMARY, Logfile.LOGFILE,
                        "logfile_ibfk_1", Logfile.LOGFILE.BUCKET_ID
                );
        public static final ForeignKey<LogfileRecord, HostRecord> LOGFILE_IBFK_2 = Internal
                .createForeignKey(
                        com.teragrep.pth_06.jooq.generated.journaldb.Keys.KEY_HOST_PRIMARY, Logfile.LOGFILE,
                        "logfile_ibfk_2", Logfile.LOGFILE.HOST_ID
                );
    }
}
