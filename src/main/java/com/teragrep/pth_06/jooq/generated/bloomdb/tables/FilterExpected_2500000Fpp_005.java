...
public class FilterExpected_2500000Fpp_005 extends TableImpl<FilterExpected_2500000Fpp_005Record> {
     ...
     */
    public final TableField<FilterExpected_2500000Fpp_005Record, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>bloomdb.filter_expected_2500000_fpp_005.partition_id</code>.
     */
    public final TableField<FilterExpected_2500000Fpp_005Record, ULong> PARTITION_ID = createField(DSL.name("partition_id"), org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>bloomdb.filter_expected_2500000_fpp_005.filter</code>.
     */
    public final TableField<FilterExpected_2500000Fpp_005Record, byte[]> FILTER = createField(DSL.name("filter"), org.jooq.impl.SQLDataType.BLOB.defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.BLOB)), this, "");
    ...
    private FilterExpected_2500000Fpp_005(Name alias, Table<FilterExpected_2500000Fpp_005Record> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""));
    }

    public <O extends Record> FilterExpected_2500000Fpp_005(Table<O> child, ForeignKey<O, FilterExpected_2500000Fpp_005Record> key) {
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.FILTER_EXPECTED_2500000_FPP_005_PARTITION_ID, Indexes.FILTER_EXPECTED_2500000_FPP_005_PRIMARY);
    }
    ...
    public List<UniqueKey<FilterExpected_2500000Fpp_005Record>> getKeys() {
        return Arrays.<UniqueKey<FilterExpected_2500000Fpp_005Record>>asList(Keys.KEY_FILTER_EXPECTED_2500000_FPP_005_PRIMARY, Keys.KEY_FILTER_EXPECTED_2500000_FPP_005_PARTITION_ID);
    }
