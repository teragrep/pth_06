...
public final class NestedTopNQuery {
    ...
    public Table<Record> getTableStatement(Condition journaldbConditionArg, Date day) {
        ...
        if (excludePatternEnabled && streamDBClient.bloomEnabled()) {
            ...
            WithoutPatternCondition withoutPatternCondition = new WithoutPatternCondition(
                    streamDBClient.ctx(),
                    excludePattern
            );
            journaldbConditionArg = journaldbConditionArg.and(withoutPatternCondition.condition());
        }
