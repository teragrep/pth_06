 ...
 */
public final class RowConverterImpl implements RowConverter {

    private final Logger LOGGER = LoggerFactory.getLogger(RowConverterImpl.class);
    ...
    public InternalRow get() {
        ...
        final long timeStamp = rfc3339ToEpoch(new RFC5424Timestamp(rfc5424Frame.timestamp).toZonedDateTime());
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER
                    .trace(
                            "PARSED  timestamp: " + timeStamp + "  message: "
        ...
        auditPlugin
                .audit(
                        timeStamp, rfc5424Frame.msg.toBytes(), this.directory.getBytes(), this.stream.getBytes(),
