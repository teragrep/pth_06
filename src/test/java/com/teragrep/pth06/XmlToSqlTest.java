...
import com.teragrep.pth06.planner.OffsetPlanner;
...
public class XmlToSqlTest {
    ...
    void fromStringTest_StreamDB_DropIndexStringAndEarliest() throws Exception {
        ...
        q = "<OR><AND><AND><index value=\"haproxy\" operation=\"NOT_EQUALS\"/><sourcetype value=\"xnet:haproxy:haproxy\" operation=\"EQUALS\"/></AND><host value=\"zong.xnet.fi\" operation=\"EQUALS\"/></AND><AND><AND><AND><index value=\"*\" operation=\"EQUALS\"/><host value=\"salengar.xnet.fi\" operation=\"EQUALS\"/></AND><earliest value=\"1611657303\" operation=\"GE\"/></AND><indexstring value=\"Denied\" /></AND></OR>";
        e ="(\n" +
                "  (\n" +
                "    not (\"streamdb\".\"stream\".\"directory\" like 'haproxy')\n" +
                "    and \"streamdb\".\"stream\".\"stream\" like 'xnet:haproxy:haproxy'\n" +
    ...
    void fromStringTest_JournalDB_OrTimestampGTE() throws Exception {
        ...
        String e;
        String result;
        q = "<OR><AND><AND><index value=\"haproxy\" operation=\"NOT_EQUALS\"/><sourcetype value=\"xnet:haproxy:haproxy\" operation=\"EQUALS\"/></AND><host value=\"zong.xnet.fi\" operation=\"EQUALS\"/></AND><AND><AND><AND><index value=\"*\" operation=\"EQUALS\"/><host value=\"salengar.xnet.fi\" operation=\"EQUALS\"/></AND><earliest value=\"1611612000\" operation=\"GE\"/></AND><indexstring value=\"Denied\" /></AND></OR>";
        // Add time ranges
    ...
    void fromStringTest_JournalDB_OrTimestampLTE() throws Exception {
        ...
        String e;
        String result;
        q = "<OR><AND><AND><index value=\"haproxy\" operation=\"NOT_EQUALS\"/><sourcetype value=\"xnet:haproxy:haproxy\" operation=\"EQUALS\"/></AND><host value=\"zong.xnet.fi\" operation=\"EQUALS\"/></AND><AND><AND><AND><index value=\"*\" operation=\"EQUALS\"/><host value=\"salengar.xnet.fi\" operation=\"EQUALS\"/></AND><latest value=\"1611611999\" operation=\"LE\"/></AND><indexstring value=\"Denied\" /></AND></OR>";
        // Add time ranges
