...
public class MockDBData {
    ...
    private final TreeMap<Long, Result<Record10<ULong, String, String, String, String, Date, String, String, ULong, ULong>>> virtualDatabaseMap = new TreeMap<>();
    ...
    public TreeMap<Long, Result<Record10<ULong, String, String, String, String, Date, String, String, ULong, ULong>>> getVirtualDatabaseMap() {
        // id, directory, stream, host, logtag, logdate, bucket, path, logtime, filesize
        return virtualDatabaseMap;
    }

    static Result<Record10<ULong, String, String, String, String, Date, String, String, ULong, ULong>> generateResult(
            String id,
            String directory,
            String stream,
            String host,
        ...
        MockDataProvider provider = new MockDataProvider() {
            ...
            public MockResult[] execute(MockExecuteContext ctx) throws SQLException {
                ...
                Result<Record10<ULong, String, String, String, String, Date, String, String, ULong, ULong>> result =
                        create.newResult(
                                StreamDBClient.SliceTable.id,
                                StreamDBClient.SliceTable.directory,
                                StreamDBClient.SliceTable.stream,
                                StreamDBClient.SliceTable.host,
                                StreamDBClient.SliceTable.logtag,
                                StreamDBClient.SliceTable.logdate,
                ...
                Record10<ULong, String, String, String, String, Date, String, String, ULong, ULong> newRecord = create.newRecord(
                        StreamDBClient.SliceTable.id,
                        StreamDBClient.SliceTable.directory,
                        StreamDBClient.SliceTable.stream,
                        StreamDBClient.SliceTable.host,
                ...
                if (
                    ...
                    newRecord.set(StreamDBClient.SliceTable.logtime, ULong.valueOf(logtime));
        ...
        return create.select(StreamDBClient.SliceTable.id,
                StreamDBClient.SliceTable.directory,
                StreamDBClient.SliceTable.stream,
                StreamDBClient.SliceTable.host,
                StreamDBClient.SliceTable.logtag,
