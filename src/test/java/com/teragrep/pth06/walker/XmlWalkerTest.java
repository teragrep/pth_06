package com.teragrep.pth06.walker;
...
import com.teragrep.pth06.XmlToSqlTest;
import com.teragrep.pth06.planner.walker.ConditionWalker;
import com.teragrep.pth06.planner.walker.PlainWalker;
...
public class XmlWalkerTest {
    ...
    void fromStringIntendTest() throws Exception {
        ...
        String q = "<OR><AND><AND><index value=\"haproxy\" operation=\"NOT_EQUALS\"/><sourcetype value=\"xnet:haproxy:haproxy\" operation=\"EQUALS\"/></AND><host value=\"zong.xnet.fi\" operation=\"EQUALS\"/></AND><AND><AND><AND><index value=\"*\" operation=\"EQUALS\"/><host value=\"salengar.xnet.fi\" operation=\"EQUALS\"/></AND><earliest value=\"2021-01-21T11:58:37\"/></AND><indexstring value=\"Denied\" /></AND></OR>";
        walker.fromString(q);
        LOGGER.debug("---------------");
        q = "<AND><index value=\"haproxy\" operation=\"NOT_EQUALS\"/><sourcetype value=\"xnet:haproxy:haproxy\" operation=\"EQUALS\"/></AND>";
        walker.fromString(q);
        LOGGER.debug("---------------");
    }
