...
import com.teragrep.pth06.planner.walker.KafkaWalker;
...
public class KafkaWalkerTest {
    ...
    void fromStringAndNotEquals() throws Exception {
        String q = "<AND>" +
                ...
                "<index value=\"zongprox*\" operation=\"EQUALS\"/>" +
                "</AND>";
        String e = "^zongprox.*$";
    ...
    void fromStringOrTest() throws Exception {
        String q = "<OR>" +
                "<index value=\"nanprox*\" operation=\"EQUALS\"/>" +
                "<index value=\"zongprox*\" operation=\"EQUALS\"/>" +
                "</OR>";
    ...
    void fromStringOrNotEquals() throws Exception {
        String q = "<OR>" +
                "<index value=\"nanprox*\" operation=\"NOT_EQUALS\"/>" +
                "<index value=\"zongprox*\" operation=\"EQUALS\"/>" +
                "</OR>";
        String e = "^zongprox.*$";
        String result = kafkaWalker.fromString(q);//.toString();
    ...
    void fromStringInner() throws Exception {
        ...
        String q = "<OR>" +
                "<AND>" +
                "<index value=\"nanprox*\" operation=\"EQUALS\"/>" +
                "<sourcetype value=\"sauce*\" operation=\"EQUALS\"/>" +
                "</AND>" +
                "<AND>" +
                "<sourcetype value=\"innersauce*\" operation=\"EQUALS\"/>" +
                "<index value=\"innerzong*\" operation=\"EQUALS\"/>" +
                "</AND>" +
                "</OR>";
    ...
    void fromStringOrNot() throws Exception {
        ...
        String q = "<OR>" +
                "<AND>" +
                "<index operation=\"EQUALS\" value=\"cpu\"/>" +
                "<sourcetype operation=\"EQUALS\" value=\"log:cpu:0\"/>" +
                "</AND>" +
                "<NOT>" +
                "<indexstatement operation=\"EQUALS\" value=\"src\"/>" +
                "</NOT>" +
                "</OR>";
        String e = "^cpu$";
        String result = kafkaWalker.fromString(q);//.toString();
