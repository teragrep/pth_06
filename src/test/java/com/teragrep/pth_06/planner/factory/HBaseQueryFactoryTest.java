...
public class HBaseQueryFactoryTest {
    ...
    @Test
    public void testHBaseEnabled() {
        Factory<HBaseQuery> hBaseQueryFactory = new HBaseQueryFactory(new Config(opts));
        HBaseQuery hBaseQuery = hBaseQueryFactory.object();
        Assertions.assertFalse(hBaseQuery.isStub());
    }

    @Test
    public void testArchiveDisabled() {
        Map<String, String> hbaseDisabled = new HashMap<>(opts);
        hbaseDisabled.put("hbase.enabled", "false");
        Factory<HBaseQuery> hBaseQueryFactory = new HBaseQueryFactory(new Config(hbaseDisabled));
        HBaseQuery archiveQuery = hBaseQueryFactory.object();
