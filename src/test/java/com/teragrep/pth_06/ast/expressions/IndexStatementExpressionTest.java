...
public final class IndexStatementExpressionTest {

    @Test
    public void testValues() {
        final ValueExpression expression = new IndexStatementExpression("value", "operation");
    ...
    public void testContract() {
        EqualsVerifier.forClass(IndexStatementExpression.class).withNonnullFields("value", "operation", "tag").verify();
    }
}
